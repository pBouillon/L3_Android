...
public class Racket {
    ...
    private int rayon = TextureFactory.getTexRacket().getHeight()/2;
    ...
    void reset() {
        setPos(
                ((TextureFactory.getTexBack().getWidth()-TextureFactory.getTexBorder().getWidth())/2)
                        -(TextureFactory.getTexRacket().getWidth()/2),
                TextureFactory.getTexBorder().getHeight()
        );
        bgauche.setTransform(getPos().x+rayon,getPos().y+rayon,0);
        bmilieu.setTransform(0,0,0);
        bdroite.setTransform((getPos().x + TextureFactory.getTexRacket().getWidth()-(2*rayon))+rayon,getPos().y+rayon,0);
    }
}
